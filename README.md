...
[![Trained On](https://img.shields.io/badge/Trained_On-427_Sites-22d3ee?style=flat-square&labelColor=0d0a18)](https://github.com/)
[![Avg Score](https://img.shields.io/badge/Avg_Score-6.8%2F10-34d399?style=flat-square&labelColor=0d0a18)](https://github.com/)
...
**AuraDKit**은 427개 사이트를 **7축**으로 학습하고, Claude Code에 주입해<br/>
...
| 항목 | 값 |
|------|-----|
| 학습 사이트 수 | **427개** (204개 프리셋 + 갤러리 자동 수집) |
...
427개 사이트에서 실측한 기준값입니다.

| 축 | 기준 점수 | 분포 | 주요 분석 항목 |
|----|-----------|------|--------------|
| Spatial Rhythm | **7.8**/10 | `████████░░` | 4px 그리드, 평균 간격 12–32px |
| Layout | **7.5**/10 | `████████░░` | 반응형 3단계+, 시맨틱 구조 |
| Typography | **7.4**/10 | `███████░░░` | 모듈러 스케일, 행간 1.4–1.75, 폰트 페어링 2종 |
| Motion | **6.7**/10 | `███████░░░` | transform/opacity만, 60fps 유지 |
| Visual Hierarchy | **6.6**/10 | `███████░░░` | H1+Hero+CTA 삼위일체, 시선 집중 |
| Component | **6.1**/10 | `██████░░░░` | 4상태 필수, 스타일 일관성 80%+ |
| Color | **5.8**/10 | `██████░░░░` | OKLCH, WCAG AA 90%+ 통과 |

> **설계 기준**: 평균 6.8/10 · Drift 20/100 · AI-Slop 7/100
...
*AuraDKit v5.3 · Trained on 427 sites · Powered by [AuraKit](https://github.com/)*
