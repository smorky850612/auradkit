...
*Confidence: 52% | Threshold: 6.2/10*
...
### 단일 H1 + Hero + CTA 조합
*Confidence: 90% | Threshold: 7.2/10*
...
*Confidence: 53% | Threshold: 6.5/10*
...
*Confidence: 82% | Threshold: 8.2/10*
...
*Confidence: 74% | Threshold: 6.7/10*
...
### WCAG AA 대비율 90%+ 통과
*Confidence: 65% | Threshold: 7.3/10*
...
### CSS 커스텀 프로퍼티 2종 이상
*Confidence: 57% | Threshold: 6.6/10*
...
### 평균 간격 12-32px 범위
*Confidence: 64% | Threshold: 7.6/10*
