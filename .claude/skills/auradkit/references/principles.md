...
*Confidence: 94% | Threshold: 8.6/10*
...
*Confidence: 47% | Threshold: 5.8/10*
...
### 컴포넌트 스타일 일관성 80%+
*Confidence: 93% | Threshold: 8.2/10*
...
### 모듈러 스케일 80%+ 준수
*Confidence: 84% | Threshold: 7.1/10*
...
*Confidence: 50% | Threshold: 6.3/10*
...
*Confidence: 70% | Threshold: 6.5/10*
...
### 평균 간격 12-32px 범위
*Confidence: 61% | Threshold: 7.4/10*
