...
*Confidence: 44% | Threshold: 5.5/10*
...
### 단일 H1 + Hero + CTA 조합
*Confidence: 86% | Threshold: 7.1/10*
...
*Confidence: 48% | Threshold: 6.2/10*
...
### 모듈러 스케일 80%+ 준수
*Confidence: 81% | Threshold: 7.1/10*
...
*Confidence: 70% | Threshold: 7.6/10*
...
### 4px 배수 간격 시스템 80%+ 준수
*Confidence: 72% | Threshold: 7.5/10*
...
### 평균 간격 12-32px 범위
*Confidence: 60% | Threshold: 7.4/10*
...
*Confidence: 72% | Threshold: 6.6/10*
...
### 컴포넌트 스타일 일관성 80%+
*Confidence: 58% | Threshold: 6.6/10*
...
### CSS 커스텀 프로퍼티 2종 이상
*Confidence: 52% | Threshold: 6.3/10*
