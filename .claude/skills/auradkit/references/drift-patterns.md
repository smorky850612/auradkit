...
### [HIGH] 임의 픽셀 간격 사용
*Occurrences: 22 | Detection: 4px 배수 준수율 < 70%*
...
*Occurrences: 1 | Detection: 고유 간격값 > 12종*
...
### [HIGH] 폰트 크기 과다 (8종 이상)
*Occurrences: 1 | Detection: 고유 폰트 크기 > 8종*
...
### [MEDIUM] 비표준 폰트 크기 사용
*Occurrences: 1 | Detection: 모듈러 스케일 준수율 < 60%*
...
*Occurrences: 4 | Detection: 인라인 스타일 또는 클래스에 HEX/RGB 리터럴 존재*
...
*Occurrences: 4 | Detection: 렌더링된 고유 색상 > 30종*
...
*Occurrences: 46 | Detection: 고유 border-radius > 5종 (0 제외)*
...
### [MEDIUM] 그림자 과용
*Occurrences: 39 | Detection: 그림자 적용 요소 > 총 요소의 15%*
...
*Occurrences: 59 | Detection: CSS에 prefers-reduced-motion 규칙 없음*
...
*Occurrences: 9 | Detection: transition에 width/height/top/left 포함*
